...
N_EPOCH_OUTER: int = 1
N_EPOCH_INNER_CLS: int = 10
N_EPOCH_INNER_CONF: int = 10
CONF_RECORD_EPOCH: int = 9
LR: float = 1e-3
...
if __name__ == "__main__":
    ...
    parser.add_argument("--noise_type", type=str, help="Noise type", default='linear', choices={"linear", "uniform", "asymmetric"})

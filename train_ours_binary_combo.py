...
def main(args):
    ...
    model_cls = resnet18(num_classes=10, in_channels=input_channel)
    # model_conf = resnet18(num_classes=1, in_channels=input_channel)
    model_conf = ResNet18_Combo_Plus(num_classes=10, in_channels=input_channel)

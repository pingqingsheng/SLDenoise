...
class Clothing1M(data.Dataset):
    def __init__(self, data_root=None, split='train', transform=None):
        if data_root is None:
            self.data_root = '/media/pwu/Data/2D_data/Clothing1M/'
        else:
...
class Clothing1M_confidence(data.Dataset):

    def __init__(self, data_root, labels , split='train', transform=None):
...
if __name__ == '__main__':
    ...
    image = Image.open('/media/pwu/Data/2D_data/Clothing1M/images/3/98/512656970,1295644398.jpg')
